import BookingRequest, { IBookingRequest } from './BookingRequest';
import { IBookingRequestRepository, BookingRequestQueryFilters } from '../../shared/interfaces/repositories/IBookingRequestRepository';

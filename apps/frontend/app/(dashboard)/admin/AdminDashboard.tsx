...
import { Card, Badge, Button } from '@/components/pages/ui';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ user, bookings }) => {
                                                        ...
                                                        {wardens.map((warden) => (
                                                            <tr key={warden.id} className="hover:bg-slate-50 transition-colors">
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                                                    {warden.createdAt ? new Date(warden.createdAt).toLocaleDateString() : 'N/A'}
                                                                </td>
                                                    ...
                                                    {displayBookings.map((booking) => {
                                                        ...
                                                        return (
                                                            <tr key={booking.id} className="hover:bg-slate-50 transition-colors">
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-slate-900">${String(booking.totalPrice || '0')}</td>
                                                                <td className="px-6 py-4 whitespace-nowrap">
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                                    {status === 'paid' && !booking.checkInCompleted && (
                                                                        <Button onClick={() => handleCheckIn(booking.id)} className="bg-blue-600 hover:bg-blue-700 text-white">
                                                                            Check In
                                                                        </Button>
                                                                    )}
                                                                    {booking.checkInCompleted && !booking.checkOutCompleted && (
                                                                        <Button onClick={() => handleCheckOut(booking.id)} className="bg-orange-500 hover:bg-orange-600 text-white">
                                                                            Check Out
                                                                        </Button>
                                                                    )}
                                                                </td>

...
import { Card, Button, Badge } from '@/components/pages/ui';
                                    ...
                                    <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                                        <div className="flex items-center gap-2 text-slate-900">
                                            ...
                                            <span className="font-bold text-lg">
                                                ${String(booking.totalPrice || (booking.room?.price || 0) * Math.ceil((new Date(booking.checkOutDate).getTime() - new Date(booking.checkInDate).getTime()) / (1000 * 60 * 60 * 24)))}
                                            </span>
